            ...
            <div className="container">
                <div className="about__wrapper">
                    <div className="about__list">
                        ...
                        <div className="about__list-item">
                            <p className="about__text">
                                Община была образована в 2011 году Приморский край г. Артём, мы входим в международную конгрегацию "Чозен пипл министриз" или "Служение избранному народу".  Мы регулярно собираемся по субботам  в городе Артем, ул. Пушкина 16. Начало Богослужения в 11-00 час. Отмечаем праздники и проводим время вместе, изучая Слово Божье в простоте сердца.
                            </p>
                        </div>
